...
const { infoLogger, errLogger } = require("./logger");
const ip = require("ip");
class APIfeatures {
...
const productController = {
  ...
  async createProduct(req, res, next) {
    ...
    try {
      ...
      infoLogger.info(`Name : ${name} Product inserted`, {
        userIP: `${ip.address()}`,
      });
  ...
  async updateProducts(req, res, next) {
    try {
      ...
      infoLogger.info(`product id ${req.params.id} updated`, {
        userIP: `${ip.address()}`,
      });
  ...
  async deleteProducts(req, res, next) {
    try {
      try {
        ...
        infoLogger.info(`product id ${req.params.id} deleted`, {
          userIP: `${ip.address()}`,
        });
      } catch (err) {
        return next(err);
