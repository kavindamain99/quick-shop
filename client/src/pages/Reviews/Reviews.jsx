...
import he from "he"; // Import the "he" library for HTML entity encoding
...
const Reviews = () => {
  ...
  const productReviewsSubmitHandler = (e) => {
    e.preventDefault();
    const productIdSanitized = he.encode(productId); // Sanitize user input
    dispatch(getAllReviews(productIdSanitized));
  };
